...
class Item:
    ...
    def display_names(self, surface, name, cost, selected):
        ...
        #title text
        title_surf = self.font.render(name, False, TEXT_COLOR, color)
        title_rect = title_surf.get_rect(midtop = self.rect.midtop + pygame.math.Vector2(0, 20))

        #cost text
        cost_surf = self.font.render(f"{int(cost)}", False, TEXT_COLOR, color)
    ...
    def displa_bar(self, surface, value, max_value, selected):
    ...
    def display(self, surface, selection_num, name, value, max_value, cost):
        ...
        self.displa_bar(surface, value, max_value, self.index == selection_num)
